...
|----------|---------|------|-------------|--------|---------|
| BFA-Fraud-Detection-Models | Complete Python code for model development.| [Link](https://github.com/mrlizhaozhi/bank-account-fraud-detection/blob/main/BAF-Fraud-Detection-Model.ipynb) | 22 Feb 2026 | In Progress | Feature engineering completed. |
